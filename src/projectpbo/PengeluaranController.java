...
public class PengeluaranController {
    ...
    @FXML private Label lblTotalPengeluaran, lblSaldo, lblError;
    ...
    private void tambah() throws SQLException {
        ...
        try {
            ...
            try (Connection c = Database.getConnection()) {PreparedStatement psSaldo = c.prepareStatement("SELECT saldo FROM saldo WHERE id=?");
                ...
                c.prepareStatement("INSERT INTO transaksi (saldo_id,tipe,jumlah,ket) VALUES (" + Session.accountId + ",'PENGELUARAN'," + j + ",'" + ketField.getText() + "')").executeUpdate();
